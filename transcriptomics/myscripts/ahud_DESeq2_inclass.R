##this is my .r script for exploring the A. husonica RNAseq data
##Using DESeq2
...
hist(apply(countsTableRound,1,mean),xlim=c(0,1000), ylim=c(0,43000),breaks=10000)
...
##################################
#next bit of code lets us look for outlier samples
##################################
...
#let's make this prettier and easier to interpret by separating generations
...
png("PCA_allGens.png", res=300, height=5, width=5, units="in")
